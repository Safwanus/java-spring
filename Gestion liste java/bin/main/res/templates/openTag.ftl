...
<html>
   ...
   <body>
      ...
      <h1>TAG <span style="color: #FFCD39"><strong>${tagname}</strong></span></h1>
      <hr/>
      <div class="table-responsive-sm">
         <table class="table">
            ...
            <tr>
               ...
               <td>
                  <form method="POST" action="/deleteTagElement">
                     <input id="tagname" name="tagname" type="hidden" value="${tagname}">
                     <button name="id" class="btn btn-dark" type="submit" value="${system.getId()}" >Supprimer Tag </button>
                  </form>
               </td>
               <td>
