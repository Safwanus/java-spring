...
<html lang="en">
   ...
   <body style="background-color: #F9F8F5">
      <div class="login-form">
         ...
         <div class="form-group">
            <h5 class="text-center">ID de l'element partager: <span style="color: #D33D09"><strong>${idElem}</strong></span></h5>
            <h5 class="text-center">Partager avec la liste: <span style="color: #D33D09"><strong>${titre}</strong></span></h5>
         </div>
         <div class="form-group">
            </br></br></br></br>
