...
<html>
   ...
   <body>
      ...
      <h1>Ajouter une nouvelle sous-liste</h1>
      <form method="POST" action="/addNewSubList">
         ...
         <button name="idList" class="btn btn-primary" type="submit" value="${idList}" >Ajouter une nouvelle liste</button>  
      </form>
   </body>
</html>