   ...
   <body>
      ...
      <form method="POST" action="/addNewList">
         <div class="form-group">
            <label for="exampleInputEmail1">Titre de votre liste</label>
            <input type="text" class="form-control" id="titleList"  name="title" placeholder="Entrer un titre">
         </div>
         <div class="form-group">
            <label for="exampleTextarea">Description</label>
            <textarea class="form-control" id="exampleTextarea" rows="3" type="text" name="description" ></textarea>
         </div>
         <button name="idUser" class="btn btn-primary" type="submit" value="${idUser}" >Ajouter une nouvelle liste</button>  
      </form>
   </body>
</html>