         ...
         <div class="row main">
            <div class="main-login main-center">
               ...
               <form class="" method="POST" action="/createAccount">
                  ...
                  <div class="form-group ">
                     <button type="submit" class="btn btn-primary btn-lg btn-block login-button">Créer un compte et se connecter.</button>
                  </div>
               </form>
            </div>
            <a class="navbar-brand" href="/" ><strong></br></br></br>Revenir au panneau de connexion</strong></a>
         </div>
      </div>
