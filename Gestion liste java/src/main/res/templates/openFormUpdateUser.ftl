      ...
      <div class="container">
         <div class="row main">
            <div class="main-login main-center">
               ...
               <form class="" method="POST" action="/updateUser">
                  ...
                  <div class="form-group ">
                     <button name="idUser" class="btn btn-primary" type="submit" value="${idUser}">Mettre à jour et revenir au panneau administrateur.</button>
                  </div>
               </form>
            </div>
         </div>
